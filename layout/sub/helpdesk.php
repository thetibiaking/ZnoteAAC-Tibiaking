	...
	if (isset($_GET['success']) && empty($_GET['success'])) {
		...
		<form action="" method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="username" value="<?php echo $account['name']; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input class="form-control" type="text" name="email" value="<?php echo $account['email']; ?>" readonly>
            </div>
            <div class="form-group">
