...
<form action="" method="<?php if (!$name) echo "get"; else echo "post";?>">
	...
	<table class="table">
		...
		<tr>
			<td>
				<input name="name" class="form-control" type="text" placeholder="Character name" <?php if ($name !== false) echo "value='$name' disabled";?>>
				<br><br>
				Vocation:<br>
				<select class="form-control" name="vocation" <?php if (!$name) echo "disabled";?>>
					<?php
				...
				<br><br>
				Fist fighting:<br>
				<input name="fist" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 0); ?>">
				<br><br>
				Club fighting:<br>
				<input name="club" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 1); ?>">
				<br><br>
				Sword fighting:<br>
				<input name="sword" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 2); ?>">
				<br><br>
				Axe fighting:<br>
				<input name="axe" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 3); ?>">
				<br><br>
			</td>
			<td>
				Dist fighting:<br>
				<input name="dist" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 4); ?>">
				<br><br>
				Shield fighting:<br>
				<input name="shield" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 5); ?>">
				<br><br>
				Fish fighting:<br>
				<input name="fish" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 6); ?>">
				<br><br>
				Level:<br>
				<input name="level" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 8); ?>">
				<br><br>
				Magic level:<br>
				<input name="magic" class="form-control" type="text" <?php if (!$name) echo "disabled";?> value="<?php echo playerSkill($skills, 7); ?>">
				<br><br>
			</td>
		</tr>
		<tr>
